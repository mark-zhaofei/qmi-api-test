...
#define NAS_V01_IDL_MINOR_VERS 0x85
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define NAS_V01_MAX_MESSAGE_ID 0x00A8
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Controls the reporting of QMI_NAS_T3346_TIMER_STATUS_CHANGE_IND. Values: \n
       - 0x00 -- Disable (default value) \n
       - 0x01 -- Enable
    */
...
typedef struct {
  ...
  */
  ...
  /**<   List of the user-configured LTE bands, ordered by priority. The ordering 
       ...
       - 120 to 157 -- LTE band classes (see Table @latexonly\ref{tbl:bandClass}@endlatexonly for details)
  */
 ...
 */
  ...
  /* Optional */
  /*  Periodic Search is Performed When in Home/Home and Roaming */
 ...
 */
  ...
  /* Optional */
  /*  Sort CSG Search Results Based on RAT List */
 ...
 */
  ...
  /* Optional */
  /*  Sort CSG Search Results Based on Signal Type */
...
typedef struct {
  ...
  /**<   Access barring factor for voice calls. Range: 0 to 100.
       Indicates network sent barring factor recieved from sib2 rrc message.
       Value 0xFF indicates Invalid.
       All values are per \hyperref[S21]{[S21]}.
  */
  ...
  /**<   Access barring time (in seconds) for voice calls. Range: 0 to 512.
       Indicates network sent barring time received from sib2 rrc message.
       Value 0xFFFF indicates Invalid.
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Retrieves the Data roaming status from modem. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; Retrieves the Better system reselection timer value from modem. */
typedef struct {
  /* This element is a placeholder to prevent the declaration of 
     an empty struct.  DO NOT USE THIS FIELD UNDER ANY CIRCUMSTANCE */
  char __placeholder;
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Request Message; This API is used to scale the wake up duration by controlling idle mode DRX cycle 
	                  and this API can also be used to skip the idle mode measurements. */
typedef struct {
  ...
  */
  ...
  /**<    Skips Idle mode measurements Values: \n
    - 0x00 -- FALSE \n
    - 0x01 -- TRUE
  */
...
/** @addtogroup nas_qmi_messages
    @{
  */
/** Response Message; This API is used to scale the wake up duration by controlling idle mode DRX cycle 
	                  and this API can also be used to skip the idle mode measurements. */
typedef struct {
